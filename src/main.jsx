...
import SvgJotai from './svg.jotai';
...
const links = [
  ...
  {title: 'Advanced Jotai', url:'advanced-jotai', date:"2023-01-05", desc:"Advanced use of Jotai with example SVG drawing app", element:<SvgJotai/>,status:"Completed"},
